...
def _select_target(
  *,
  ...
  the protective stop left fixed. A selected 1:1 publishes a **single**
  target and books **full volume** at that print (close_ratio=1.0). A
  fixed-RR instrument expands the selected final target into its
  configured R ladder during execution-policy planning.
  """
